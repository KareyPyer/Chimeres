...
# ═══════════════════════════════════════════════════════════════════════════════
# [EMBARQUÉ — ex-ArcheoEpidemic_Chimera2a.py] EXPORT JSON COMPLET
# ═══════════════════════════════════════════════════════════════════════════════
# Cette fonction était auparavant chargée dynamiquement depuis
# "ArcheoEpidemic_Chimera2a.py" via importlib (cf. ancien bloc --export-json
# dans main()). Elle est désormais embarquée nativement : v4a2 n'a plus
# aucune dépendance externe vers le fichier v2a.
...
def main():
    ...
    # Export JSON (natif, sans dépendance externe)
    if args.export_json:
        try:
            export_simulation_data(sim, args.export_json)
